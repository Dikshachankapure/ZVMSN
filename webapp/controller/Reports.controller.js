	...
	return Controller.extend("poc.zvms.controller.Reports", {
		...
		onSearch: function (oEvent) {
			...
			if (query1.length > 0 && query2.length > 0) {
				...
				oFilter2 = new sap.ui.model.Filter("Department", sap.ui.model.FilterOperator.Contains, query2);
				...
				oFilter2 = new sap.ui.model.Filter("Department", sap.ui.model.FilterOperator.Contains, "");
				allFilter = new sap.ui.model.Filter([oFilter1,oFilter2], false);
			}
